...
dat <- read.csv(here("data/Tyrannides/Tyrannida_575spp.csv"))

str(dat)

# reading nexus file (use ape pacakge)

tree_all <- read.nexus(here("data/Tyrannides/tree_100/Tyrannida_575spp_100.nex"))
tree <- tree_all[[1]]
...
saveRDS(mod_tyra_1, here("Rdata", "mod_tyra_1.rds"))
...
saveRDS(mod_tyra_2, here("Rdata", "mod_tyra_2.rds"))
