...
# Bonus: obtaining heritability and evolvability
...
Alternatively, we can use Equation 23:

```{r}

# original scale conversion does not seem to make sense so commented out
#igma2_as_star_orig <- sqrt( (exp(sigma2_as_star) - 1) * exp(2*ln_b0 + sigma2_as_star) )
