---
title: "ONLINE SUPPLMENT: Quantifying macro-evolutionary patterns of trait mean and variance with phylogenetic location-scale models"
...
Furthermore, we have another sister (you are in luck) paper, which teaches Bayesian generalised linear modelling both for continuous and discrete traits. You can find the tutorial [here](https://ayumi-495.github.io/multinomial-GLMM-tutorial/); also, the preprint of the sister paper is available on [EcoEvoRxiv](https://ecoevorxiv.org/repository/view/8458/):
