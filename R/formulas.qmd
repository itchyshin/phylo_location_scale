...
$$
 ...
 e_i^{(l2)} 
 \end{pmatrix} 
 \sim \mathcal{N} \left( \mathbf{0}, \mathbf{\Sigma}_{e_{i}} \otimes \mathbf{I}  \right) 
$$

$$
\mathbf{\Sigma}_{ei} \otimes \mathbf{I} = 
\begin{pmatrix} \sigma_{ei(l1)}^{2} \mathbf{I} & 
\rho_{ls}\sigma_{el1}\sigma_{al2} \mathbf{I}\\ 
\rho_{ls}\sigma_{el1}\sigma_{al2} \mathbf{I} &
\sigma_{al2}^{2}  \mathbf{I}
\end{pmatrix}   
$$
...
## Bivaraite phylogentic location-scale model

$$
\begin{pmatrix} y_{i1} \\
y_{i2}
\end{pmatrix} =
\begin{pmatrix} \beta_{01}^{(l)} \\
\beta_{02}^{(l)}
\end{pmatrix} +
\begin{pmatrix} \beta_{11}^{(l)} & \beta_{12}^{(l)} \\
\beta_{21}^{(l)} & \beta_{22}^{(l)}
\end{pmatrix}
$$

$$
\begin{pmatrix} \ln({\sigma_{e_{i1}}}) \\
\ln({\sigma_{e_{i2}}})
\end{pmatrix} =
\begin{pmatrix} \beta_{01}^{(s)} \\
\beta_{02}^{(s)}
\end{pmatrix} +
\begin{pmatrix} \beta_{11}^{(s)} & \beta_{12}^{(s)} \\
\beta_{21}^{(s)} & \beta_{22}^{(s)}
\end{pmatrix}
$$
