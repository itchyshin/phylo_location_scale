...
dat <- read.csv(here("data/Tyrannides/Furnariida_600spp.csv"))

str(dat)

# reading nexus file (use ape pacakge)

tree_all <- read.nexus(here("data/Tyrannides/tree_100/Furnariida_600spp_100.nex"))
tree <- tree_all[[1]]
...
saveRDS(mod_furn_1, here("Rdata", "mod_furn_1.rds"))
...
saveRDS(mod_furn_2, here("Rdata", "mod_furn_2.rds"))
